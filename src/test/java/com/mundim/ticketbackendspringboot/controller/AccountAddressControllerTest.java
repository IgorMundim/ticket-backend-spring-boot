...
@Sql(scripts = "/sql/account-address/address-insert.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(scripts = "/sql/account-address/address-delete.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
class AccountAddressControllerTest{
    MockAccountAddress input;
    @Autowired
    WebTestClient testClient;
    @BeforeEach
    void setUpMocks() throws Exception {
        input = new MockAccountAddress();
        MockitoAnnotations.openMocks(this);
    }
    @Test
    public void testWillCreateAccountAddress(){
        AddressRequestDto entityDto = input.mockDto(101);
        AddressResponseDto result = testClient
                .post()
                .uri("/api/v1/account/101/address")
    ...
    @Test
    public void testWillThrowBadRequestWhenTryCreateAccountAddressWithAddressAlreadyRegistered(){
        AddressRequestDto entityDto = input.mockDto(102);
        ErrorResponseDto result = testClient
                .post()
                .uri("/api/v1/account/102/address")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void testWillThrowUnauthorizedWhenTryCreateAccountAddressWithoutAuthorization(){
        AddressRequestDto entityDto = input.mockDto(102);
        ErrorResponseDto result = testClient
                .post()
                .uri("/api/v1/account/102/address")
    ...
    @Test
    public void testWillThrowBadRequestWhenTryCreateAccountAddressWithoutValidAccount(){
        AddressRequestDto entityDto = input.mockDto(102);
        ErrorResponseDto result = testClient
                .post()
                .uri("/api/v1/account/110/address")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(entityDto)
                .exchange()
                .expectStatus().isUnauthorized()
    ...
    @Test
    public void testWillGetAccountAddress(){
        AddressResponseDto result = testClient
                .get()
                .uri("/api/v1/account/address/101")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "admin", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(AddressResponseDto.class)
    ...
    @Test
    public void testWillThrowNotFoundWhenTryGetAccountAddressWithInvalidId(){
        ErrorResponseDto result = testClient
                .get()
                .uri("/api/v1/account/address/111")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "admin", "123456"))
                .exchange()
    ...
    @Test
    public void testWillThrowBadRequestWhenTryGetAccountAddressWithoutAuthorization(){
        ErrorResponseDto result = testClient
                .get()
                .uri("/api/v1/account/111")
                .exchange()
                .expectStatus().isUnauthorized()
                .expectBody(ErrorResponseDto.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void testWillUpdateAccountAddress(){
        AddressRequestDto entityDto = input.mockDto(101);
        AddressResponseDto result = testClient
                .patch()
                .uri("/api/v1/account/address/101")
    ...
    @Test
    public void testWillThrowNotFoundWhenTryUpdateAccountAddressWithInvalidId(){
    ...
    @Test
    public void testWillThrowBadRequestWhenTryUpdateAccountAddressWithoutAuthorization(){
        AddressRequestDto entityDto = input.mockDto(101);
        ErrorResponseDto result = testClient
                .patch()
